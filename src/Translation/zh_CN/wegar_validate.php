<?php
return [
  'The %field% field does not match the required format: %pattern%'    => '字段 %field% 必须匹配正则: %pattern%',
  'The %field% field must be an array'                                 => '字段 %field% 必须是数组',
  'The %field% field must be a valid date format: %format%'            => '字段 %field% 必须是日期格式: %format%',
  'The %field% field must be a valid email address'                    => '字段 %field% 必须是邮箱地址',
  'The %field% field must be a float'                                  => '字段 %field% 必须是浮点数',
  'The %field% decimal must be %decimal%'                              => '字段 %field% 小数点后必须为 %decimal% 位',
